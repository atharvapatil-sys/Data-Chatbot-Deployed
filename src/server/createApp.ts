...
// Using Flash as the primary model for speed and larger context window (per user request)
const GEMINI_MODEL_PRO = process.env.GEMINI_MODEL_PRO || 'gemini-1.5-flash-latest';
